angular.module('App',['ngRoute','panel.payment.befrooshim.controller','panel.payment.befrooshim.components'])
.config(['$routeProvider',function($routeProvider){
  $routeProvider
    ...
    .when('/userGateway/list/:token',{templateUrl:'partials/userGatewayList.html',controller:'userGatewayListCtrl'})
    .when('/gateway/list/:token',{templateUrl:'partials/gatewayList.html',controller:'gatewayListCtrl'})
    .when('/payment/list/:token',{templateUrl:'partials/paymentList.html',controller:'paymentListCtrl'})
    .when('/payment/pay/:paymentId',{templateUrl:'partials/pay.html',controller:'payCtrl'})
    ...
    .when('/receipt/:paymentId',{templateUrl:'partials/receipt.html',controller:'receiptCtrl'})
